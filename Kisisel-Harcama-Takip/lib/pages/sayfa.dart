...
class _StatsPageState extends State<StatsPage>
  ...
  void initState() {
    ...
    _controller = TabController(
        vsync: this,
        length: 13,
        initialIndex: int.parse(widget.model.getCurrentMonth) - 1);
                        ...
                        children: <Widget>[
                          Column(
                            children: [
                              ...
                              makeStatCrad("Toplam Harcama", Colors.red,
                                  MaterialCommunityIcons.shopping),
                              makeStatCrad("Toplam Borç", Colors.green,
                                  MaterialIcons.account_balance),
                              makeStatCrad("Net Borç", Colors.yellow,
