...
const UserSchema = CollectionSchema(
  ...
  links: {
    r'gelir': LinkSchema(
      id: 3165558133382487912,
      name: r'gelir',
      target: r'Income',
      single: true,
    ),
    r'gider': LinkSchema(
      id: -5124753192252615073,
      name: r'gider',
      target: r'Cost',
      single: true,
    )
...
List<IsarLinkBase<dynamic>> _userGetLinks(User object) {
  return [object.gelir, object.gider];
}

void _userAttach(IsarCollection<dynamic> col, Id id, User object) {
  object.id = id;
  object.gelir.attach(col, col.isar.collection<Income>(), r'gelir', id);
  object.gider.attach(col, col.isar.collection<Cost>(), r'gider', id);
}
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> gelir(FilterQuery<Income> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'gelir');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> gelirIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'gelir', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> gider(FilterQuery<Cost> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'gider');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> giderIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'gider', 0, true, 0, true);
    });
  }
}
