...
extension IncomeQueryFilter on QueryBuilder<Income, Income, QFilterCondition> {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> timeEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'time',
        value: value,
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> timeGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> timeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> timeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension IncomeQuerySortBy on QueryBuilder<Income, Income, QSortBy> {
  ...
  QueryBuilder<Income, Income, QAfterSortBy> sortByTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.asc);
    });
  }

  QueryBuilder<Income, Income, QAfterSortBy> sortByTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension IncomeQuerySortThenBy on QueryBuilder<Income, Income, QSortThenBy> {
  ...
  QueryBuilder<Income, Income, QAfterSortBy> thenByTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.asc);
    });
  }

  QueryBuilder<Income, Income, QAfterSortBy> thenByTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.desc);
    });
  }
...
extension IncomeQueryWhereDistinct on QueryBuilder<Income, Income, QDistinct> {
  ...
  QueryBuilder<Income, Income, QDistinct> distinctByTime() {
    return QueryBuilder.apply(this, (query) {
...
extension IncomeQueryProperty on QueryBuilder<Income, Income, QQueryProperty> {
  ...
  QueryBuilder<Income, int, QQueryOperations> timeProperty() {
    return QueryBuilder.apply(this, (query) {
